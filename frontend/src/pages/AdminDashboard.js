      ...
      <div className="container mx-auto px-6 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="bg-white shadow-md p-1 rounded-xl grid grid-cols-6 gap-1" data-testid="admin-tabs">
            ...
            <TabsTrigger value="microservices" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-500 data-[state=active]:to-cyan-500 data-[state=active]:text-white rounded-lg transition-all" data-testid="tab-microservices">Mikroserviset</TabsTrigger>
